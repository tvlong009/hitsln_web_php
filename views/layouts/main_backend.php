        ...
        <div class="navbar navbar-inverse navbar-fixed-top">
            ...
            <div class="container">
                <div class="navbar-header">
                    ...
                    <!-- start: LOGO -->
                    <a class="navbar-brand" href="<?php echo Yii::$app->urlManager->createAbsoluteUrl('/site-backend'); ?>">
                        ...
                        if (!Yii::$app->user->isGuest) {
                          ...
                          <li class="dropdown current-user">
                              ...
                              <ul class="dropdown-menu">
                                  ...
                                  <li>
                                      <a href="<?php echo Yii::$app->urlManager->createAbsoluteUrl('/site-backend/logout'); ?>" data-method="post">
                                          <i class="clip-exit"></i>
                                          &nbsp;<?= Yii::t('app', 'Log Out') ?>
                                      </a>
                                  </li>
            ...
            <div class="main-navigation navbar-collapse collapse">
                ...
                <ul class="main-navigation-menu">
                    <li <?php echo Yii::$app->controller->id == 'site' ? 'class="active open"' : '' ?>>
                        <a href="<?php echo Yii::$app->urlManager->createAbsoluteUrl('site-backend') ?>"><i class="clip-home-3"></i>
                    ...
                    <li <?php echo Yii::$app->controller->id == 'pages' ? 'class="active open"' : '' ?>>
                        ...
                        <ul class="sub-menu">
                            <li <?php echo (in_array(Yii::$app->controller->action->id, array('index', 'version')) && Yii::$app->controller->id == 'pages') ? 'class="active"' : '' ?> >
                    ...
                    <li <?php echo Yii::$app->controller->id == 'menu' || Yii::$app->controller->id == 'menu-item' ? 'class="active open"' : '' ?>>
                        <a href="<?php echo Yii::$app->urlManager->createAbsoluteUrl('menuwidget/menu') ?>"><i class="clip-menu-4"></i>
                            <span class="title"> <?= Yii::t('app', 'Menu') ?> </span>
                            <span class="selected"></span>
                        </a>
                    </li>
                    ...
                    <li <?php echo Yii::$app->controller->id == 'quick-link' || Yii::$app->controller->id == 'quick-link-group' ? 'class="active open"' : '' ?>>
                        <a href="javascript:void(0)"><i class="clip-link"></i>
                            <span class="title"> <?= Yii::t('app', 'Quick Links') ?> </span><i class="icon-arrow"></i>
                            <span class="selected"></span>
                        </a>
                        <ul class="sub-menu">
                            <li <?php echo Yii::$app->controller->id == 'quick-link-group' ? 'class="active"' : '' ?> >
                                <a href="<?php echo Yii::$app->urlManager->createAbsoluteUrl('quicklinkwidget/quick-link-group') ?>">
                                    <span class="title"> <?= Yii::t('app', 'Quick link group') ?> </span>
                                </a>
                            </li>
                            <li <?php echo (Yii::$app->controller->action->id == 'index' && Yii::$app->controller->id == 'quick-link') ? 'class="active"' : '' ?> >
                                <a href="<?php echo Yii::$app->urlManager->createAbsoluteUrl('quicklinkwidget/quick-link') ?>">
                                    <span class="title"> <?= Yii::t('app', 'All quick links') ?> </span>
                                </a>
                            </li>
                            <li <?php echo (in_array(Yii::$app->controller->action->id, array('create', 'update')) && Yii::$app->controller->id == 'quick-link') ? 'class="active"' : '' ?>>
                                <a href="<?php echo Yii::$app->urlManager->createAbsoluteUrl('quicklinkwidget/quick-link/create') ?>">
                                    <span class="title"> <?= Yii::t('app', 'Add new quick link') ?> </span>
                                    <span class="badge badge-new"><?= Yii::t('app', 'New') ?></span>
                                </a>
                            </li>
                        </ul>
                    </li>
                    <!-- <li <?php echo Yii::$app->controller->id == 'social' ? 'class="active open"' : '' ?>>
                        <a href="javascript:void(0)"><i class="clip-facebook"></i>
                            <span class="title"> <?= Yii::t('app', 'Social') ?> </span><i class="icon-arrow"></i>
                            <span class="selected"></span>
                        </a>
                        <ul class="sub-menu">
                            <li <?php echo (Yii::$app->controller->action->id == 'index' && Yii::$app->controller->id == 'social') ? 'class="active"' : '' ?> >
                                <a href="<?php echo Yii::$app->urlManager->createAbsoluteUrl('socialwidget/social') ?>">
                                    <span class="title"> <?= Yii::t('app', 'All social') ?> </span>
                                </a>
                            </li>
                            <li <?php echo (in_array(Yii::$app->controller->action->id, array('add', 'edit')) && Yii::$app->controller->id == 'social') ? 'class="active"' : '' ?>>
                                <a href="<?php echo Yii::$app->urlManager->createAbsoluteUrl('socialwidget/social/add') ?>">
                                    <span class="title"> <?= Yii::t('app', 'Add new social') ?> </span>
                                    <span class="badge badge-new"><?= Yii::t('app', 'new') ?></span>
                                </a>
                            </li>
                        </ul>
                    ...
                    <!-- Slide show begin-->
                    <!-- <li <?php echo in_array(Yii::$app->controller->id, ['slide', 'item']) ? 'class="active open"' : '' ?>>
                        <a href="javascript:void(0)"><i class="clip-pencil"></i>
                            <span class="title"> <?= Yii::t('app', 'Slidewidget') ?> </span><i class="icon-arrow"></i>

                        </a>
                        <ul class="sub-menu">
                            <li <?php echo in_array(Yii::$app->controller->id, ['slide']) ? 'class=" active open"' : '' ?>>
                                <a href="javascript:void(0)">
                                    <span class="title">   <?= Yii::t('app', 'Slide') ?> </span><i class="icon-arrow"></i>

                                </a>
                                <ul class="sub-menu">
                                    <li <?php echo (Yii::$app->controller->action->id == 'index' && Yii::$app->controller->id == 'slide') ? 'class="active"' : '' ?> >
                                        <a href="<?php echo Yii::$app->urlManager->createAbsoluteUrl('slidewidget/slide') ?>">
                                            <span class="title"> <?= Yii::t('app', 'All Slides') ?> </span>
                                        </a>
                                    </li>
                                    <li <?php echo (in_array(Yii::$app->controller->action->id, array('create', 'update')) && Yii::$app->controller->id == 'slide') ? 'class="active"' : '' ?>>
                                        <a href="<?php echo Yii::$app->urlManager->createAbsoluteUrl('slidewidget/slide/create') ?>">
                                            <span class="title"> <?= Yii::t('app', 'Add new slide') ?> </span>
                                            <span class="badge badge-new"><?= Yii::t('app', 'new') ?></span>
                                        </a>
                                    </li>
                                </ul>
                        ...
                        <ul class="sub-menu">
                            <li <?php echo in_array(Yii::$app->controller->id, ['item']) ? 'class="active open"' : '' ?>>
                                <a href="javascript:void(0)">
                                    <span class="title">   <?= Yii::t('app', 'Item') ?> </span><i class="icon-arrow"></i>

                                </a>
                                <ul class="sub-menu">
                                    <li <?php echo (Yii::$app->controller->action->id == 'index' && Yii::$app->controller->id == 'item') ? 'class="active"' : '' ?> >
                                        <a href="<?php echo Yii::$app->urlManager->createAbsoluteUrl('slidewidget/item') ?>">
                                            <span class="title"> <?= Yii::t('app', 'All Items') ?> </span>
                                        </a>
                                    </li>
                                    <li <?php echo (in_array(Yii::$app->controller->action->id, array('create', 'update')) && Yii::$app->controller->id == 'item') ? 'class="active"' : '' ?>>
                                        <a href="<?php echo Yii::$app->urlManager->createAbsoluteUrl('slidewidget/item/create') ?>">
                                            <span class="title"> <?= Yii::t('app', 'Add new item') ?> </span>
                                            <span class="badge badge-new"><?= Yii::t('app', 'new') ?></span>
                                        </a>
                                    </li>
                                </ul>
                    ...
                    <li <?php echo Yii::$app->controller->id == 'languages' ? 'class="active open"' : '' ?>>
                        ...
                        <ul class="sub-menu">
                            ...
                            <li <?php echo (in_array(Yii::$app->controller->action->id, array('languagesetting')) && Yii::$app->controller->id == 'languages') ? 'class="active"' : '' ?>>
                    ...
                    <li <?php echo in_array(Yii::$app->controller->id, array('users', 'roles', 'permission', 'assignment', 'user-property')) ? 'class="active open"' : '' ?>>
                        ...
                        <ul class="sub-menu">
                            ...
                            <li <?php echo (Yii::$app->controller->id == 'user-property') ? 'class="active"' : '' ?>>
                                <a href="<?php echo Yii::$app->urlManager->createUrl('userpropertywidget/user-property') ?>">
                                    <span class="title"> <?= Yii::t('app', 'User properties') ?></span>
                                </a>
                            </li>
                    ...
                    <!--<li <?php echo in_array(Yii::$app->controller->id, array('setting', 'activity')) ? 'class="active open"' : '' ?>>
                        <a href="javascript:void(0)">
                            <i class="clip-earth-2 "></i>
                            <span class="title">   <?= Yii::t('app', 'System') ?></span>
                        </a>
                        <ul class="sub-menu">
                            ...
                            <li <?php echo (Yii::$app->controller->id == 'activity') ? 'class="active"' : '' ?>>
                                <a href="<?php echo Yii::$app->urlManager->createUrl('useractivity/activity') ?>">
                                    <i class="clip-arrow-right "></i>
                                    <span class="title"> <?= Yii::t('app', 'User activity') ?></span>
                                </a>
                            </li>
                        </ul>
                    </li> -->
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            yii\widgets\Breadcrumbs::widget([
                              'homeLink' => array('label' => Yii::t('app', 'Home'), 'url' => Yii::$app->urlManager->createUrl('site-backend')),
