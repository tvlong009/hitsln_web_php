<!-- start: PAGE HEADER -->
<?php app\assets\MediaBackendAsset::register($this) ?>
    ...
    <div class="col-sm-12">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <form id="fileupload" action="<?php echo Yii::$app->urlManager->createAbsoluteUrl('media/upload') ?>" method="POST" enctype="multipart/form-data">
                    <input type="hidden" id="media" value="1" />
                    ...
                    <div class="row fileupload-buttonbar">
                        <div class="col-lg-9">
                            ...
                            <label style="margin-left: 10px;"><?php echo Yii::t('app', 'Check all'); ?></label>
            ...
            <script id="template-download" type="text/x-tmpl">
                ...
                <input type="checkbox" name="delete" value="1" class="toggle" style="margin-left:20px;">
                {% } else { %}
                <button class="btn btn-warning cancel">
                <i class="glyphicon glyphicon-ban-circle"></i>
                <span><?= Yii::t('app', 'Cancel') ?></span>
