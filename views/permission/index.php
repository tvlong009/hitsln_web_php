    ...
    <div class="col-sm-12">
        ...
        <div class="panel panel-default user_permission">
            ...
            <div class="panel-body">
                ...
                <div class=" col-md-12">
                    <button  type="button" class="btn btn-success buttonSaveUserPermission pull-right"><?php echo Yii::t('app', 'Save User Permission'); ?></button>
                </div>
            </div>
        ...
        <div class="panel panel-default role_permission">
            ...
            <div class="panel-body">
                ...
                <div class=" col-md-12">
                    <button  type="button" class="btn btn-success buttonSaveRolePermission pull-right"><?php echo Yii::t('app', 'Save Role Permission'); ?></button>
                </div>
            </div>
            <!-- end: FORM WIZARD PANEL -->
        </div>
