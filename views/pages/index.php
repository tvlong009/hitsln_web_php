                    ...
                    'columns' => array(
                        array(
                            ...
                            'value' => function($model, $key, $index, $columns) {
                                return '<a href="'.Yii::$app->urlManager->createAbsoluteUrl('pages/edit?id=' . $model['id']).'">'.$model['key'].'</a>';
                            }
                        ),
                        array(
                            'attribute' => 'status',
                        ...
                        array(
                            'attribute' => 'created',
                            'label' => 'Date',
                            'format' => array('date', 'php:d/m/Y H:i:s')
                        ),
                        array(
                            ...
                            'checkboxOptions' => function($model, $key, $index, $column) {
                                return ['class' => 'page_id', 'value' => $model->id];
                            },
                        ),
                            ),
                        ));
