        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-3 box_otherpage">
                ...
                <div class="col-md-12">
                    ...
                    ?>
                    <?php echo $form->field($model, 'username', ['template' => '
                    ...
                    ?>
                    <?php echo $form->field($model, 'password', ['template' => '
                        <div class="input-group input-group-lg">
						  <span class="input-group-addon" id="basic-addon1">
						 	 <i class="icon-lock"></i>
						  </span>
                    ...
                    <?php echo $form->field($model, 're_password', ['template' => '
                        <div class="input-group input-group-lg">
						  <span class="input-group-addon" id="basic-addon1">
						 	 <i class="icon-lock"></i>
						  </span>
                    ...
                    <?php } ?>
                    <?php echo $form->field($model, 'email', ['template' => '
                        <div class="input-group input-group-lg">
						  <span class="input-group-addon" id="basic-addon1">
						 	 <i class="icon-lock"></i>
						  </span>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <select name="dd" id="dd" class="form-control ">
                                    <option value="0"><?php echo Yii::t('app', 'DD') ?></option>
                                    <?php
                                    for ($i = 1; $i < 32; $i++) {
                                    ?>
                            ...
                            <div class="col-md-4">
                                <select name="mm" id="mm" class="form-control">
                                    <option value="0"><?php echo Yii::t('app', 'MM') ?></option>
                                    <?php
                                    for ($i = 1; $i < 13; $i++) {
                                        ?>
                                        <option value="<?php echo $i ?>"><?php echo $i; ?></option>
                    ...
                    <div class="form-group text_align_left">
                        <div>
                            ...
                            <label class="radio-inline">
                                <input type="radio" class="grey" value="1" checked name="gender"  id="gender_male">
