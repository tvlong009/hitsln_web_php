...
class QuickLinkController extends BackendController {
    ...
    public function actionCreate() {
        ...
        $this->getControllers(dirname(\Yii::getAlias('@webroot')));
        ...
        if (Yii::$app->request->post()) {
            ...
            if (!empty($names)) {
                if ($this->validName($names)) {
                    ...
                    $quickLink->is_blank = (int)Yii::$app->request->post('is_blank');
            ...
            if (Yii::$app->request->post()) {
                ...
                if (!empty($names)) {
                    if ($this->validName($names)) {
                        ...
                        $model->is_blank = (int)Yii::$app->request->post('is_blank');
                        ...
                        if ($model->save()) {
                            foreach ($names as $languageId => $name) {
                                ...
                                $quickLinkLanguage = QuickLinkLanguage::findOne([
                                            ...
                                            'quick_link_id' => $model->primaryKey
                                ]);
    ...
    private function getControllers($path, $ignoreFolder = array('console', 'nbproject', 'vendor', 'runtime', 'assets'), $ignoreController = array('BackendController', 'SiteController')) {
    ...
    private function getQuickLinkGroup() {
        ...
        if (!empty($language) && !empty($quickLinkGroups)) {
