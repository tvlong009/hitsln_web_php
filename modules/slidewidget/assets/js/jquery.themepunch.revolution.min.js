        ...
        revolution: function(i) {
            ...
            return this.each(function() {
                ...
                if (o.forceFullWidth == "on") {
                    ...
                    if (l == t) l = 0;
                    if (m == t) m = 0;
                   var height_fix = u.height() /2;
                    u.parent().wrap('<div style="position:relative;width:100%;height:auto;margin-top:' + m + ";margin-bottom:" + l + '" class="forcefullwidth_wrapper_tp_banner"></div>');
//                     u.closest(".forcefullwidth_wrapper_tp_banner:not(:last-child)").append('<div class="tp-fullwidth-forcer" style="width:100%;height:600px"></div>');
                    u.closest(".forcefullwidth_wrapper_tp_banner").append('<div class="tp-fullwidth-forcer" style="width:100%;height:' + height_fix + 'px"></div>');
                    u.css({
