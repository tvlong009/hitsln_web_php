    ...
    <div class="col-sm-12">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                ...
                <?= Yii::t('app','Content lists')?>

                <div class="panel-tools">
                    <a class=" btn btn-xs btn-link " href="<?php echo Yii::$app->urlManager->createAbsoluteUrl(['cmsparticles/content-list/add']); ?>">
                        <i class="fa fa-plus icon_18 color_green"></i>
                    </a>
                    <!-- btn add -->

                    <a class="btn btn-xs btn-link panel-config" href="javascript:void(0)" id="edit-contentlist">
                        <i class="fa fa-wrench icon_18 color_blue"></i>
                    </a>
                    <!-- btn edit -->

                    <a class=" btn btn-xs btn-link " href="javascript:void(0)" id="delete-contentlist">
                        <i class="fa fa-trash-o icon_18 color_red"></i>
                    </a>
                    <!-- btn delete -->


                    <a class="btn btn-xs btn-link panel-refresh" href="<?php echo Yii::$app->urlManager->createAbsoluteUrl('cmsparticles/content-list/') ?>">
            ...
            <div class="panel-body">
                ...
                $this->title = Yii::t('app', 'Content list');
                    ...
                    'columns' => array(
                        ...
                        array(
                            ...
                            'checkboxOptions' => function($model, $key, $index, $column) {
                                return ['class' => 'contentlist_id', 'value' => $model->contentlist_id];
                            },
                                ),
                            ),
                        ));
