...
<div class="col-md-6">
    ...
    echo $form->field($model, 'portfolio_name')->textInput(['placeholder' => Yii::t('app', 'Title')]);
    echo $form->field($model, 'link')->textInput(['placeholder' => Yii::t('app', 'Link')]);
    echo $form->field($model, 'portfolio_description')->textarea(['class' => 'form-control', 'placeholder' => 'Description']);
